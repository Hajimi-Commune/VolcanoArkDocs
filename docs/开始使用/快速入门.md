...
:::
# 3.配置环境并发起调用
 [Curl](/docs/82379/1399008#a7831f97)  <strong>｜</strong>[Python](/docs/82379/1399008#2832b836)  **｜**   [Go](/docs/82379/1399008#3fc72e6d)   <strong>｜</strong>  [Java](/docs/82379/1399008#0009f01e)
选择熟悉和方便的语言调用模型推理服务。
## Curl

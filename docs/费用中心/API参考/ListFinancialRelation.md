...
[去调试](https://api.volcengine.com/api-explorer/?action=ListFinancialRelation&groupName=%E4%BC%81%E4%B8%9A%E8%B4%A2%E5%8A%A1&serviceCode=billing&version=2022-01-01)
...
| 参数名称 | 类型 | 是否必选 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| Action | string | 必选 | ListFinancialRelation | 要执行的操作，取值：ListFinancialRelation。 |
...
| AccountType | integer | 可选 | 1 | 账号类型：1-主账号，2-子账号 |
| Status | integer[] | 可选 | [1] | 状态 |
...
```text
curl --location 'https://open.volcengineapi.com?Action=ListFinancialRelation&Version=2022-01-01' \

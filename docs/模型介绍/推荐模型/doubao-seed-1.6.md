...
* doubao-seed-1-6-250615：支持关闭思考，即支持 API 中的 **thinking** 字段（支持auto模式）。
* doubao-seed-1-6-251015：支持调节思考长度，即支持API中的**reasoning_effort** 字段，分为minimal、low、medium、high四种模式。可以压缩整体输出长度，平衡客户在不同场景下对效果、时延、成本的需求。

...
![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/535f563fa3974bf08fc3f3823033e6a1~tplv-goo7wpa0wc-image.image =2936x)
## 2、上传文档
文档上传处理后，点击【处理结果】可以查看文档切片，其中图片类切片，会自动识别其文字，左右对比展示。
:::tip
* 目前仅对 pdf、docx 格式文档解析开放 OCR 能力
:::
![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/1bf6b1ecbdc445efb253957af67f321e~tplv-goo7wpa0wc-image.image =1753x)
点击图片，可以放大查看原始图片内容。
![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/4ebe2384d9a9438e9fd08f89cf6453d0~tplv-goo7wpa0wc-image.image =1799x)
## 3、检索测试
点击【检索测试】，可以尝试询问与图片内容相关的问题，并查看检索返回的切片列表和分值。
![图片](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/b1a7671412364e79b5abec11d6dfb3d5~tplv-goo7wpa0wc-image.image =2916x)
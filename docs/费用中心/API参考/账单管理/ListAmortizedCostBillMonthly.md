# ListAmortizedCostBillMonthly - 分页查询成本账单总览
...
[去调试](https://api.volcengine.com/api-explorer/?action=ListAmortizedCostBillMonthly&groupName=%E8%B4%A6%E5%8D%95%E4%B8%AD%E5%BF%83&serviceCode=billing&version=2022-01-01)
...
| 参数名称 | 类型 | 是否必选 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| Action | string | 必选 | ListAmortizedCostBillMonthly | 要执行的操作，取值：ListAmortizedCostBillMonthly。 |
...
```text
curl --location 'https://open.volcengineapi.com?Action=ListAmortizedCostBillMonthly&Version=2022-01-01' \

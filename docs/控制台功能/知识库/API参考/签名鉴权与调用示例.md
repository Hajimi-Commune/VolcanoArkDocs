...
AK/SK 密钥获取方式如下，更多详情请参考 [Access Key（密钥）管理](https://www.volcengine.com/docs/6291/65568)。
   ...
   1. 单击右上角账号名下拉框中的【API 访问密钥】进入对应页面。
      ![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/c8705705d2d147baac33cb8d8f802db9~tplv-goo7wpa0wc-image.image =800x)
   2. 单击【新建密钥】按钮，可获取 AK/SK，可以此为凭证调用上述已接入应用的接口。
      ![Image](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/2333c847d3d34399a256a3996ff5ece1~tplv-goo7wpa0wc-image.image =798x)
